...
bool IsBLHardForkEnabled(const CBlockIndex* pindexPrev, const Consensus::Params& params) {
    if (pindexPrev == nullptr) {
        return false;
    }

    return IsBLHardForkEnabled(pindexPrev->nHeight, params);
}
...
static unsigned int GetBlockScriptFlags(const CBlockIndex* pindex, const Consensus::Params& consensusparams) {
    ...
    if (IsBLHardForkEnabled(pindex->pprev, consensusparams)) {
