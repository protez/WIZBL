...
public:
    CRegTestParams() {
        ...
        checkpointData = (CCheckpointData) {
            {
                {0, uint256S("2cbd2b4fb0f660dc9893976cfba24fdabf802ba17f6a5a00b162a4f581a58ffa")},
            }
        };
...
class WizblAddressChainParam : public CMainParams
{
public:
...
const CChainParams &WizblAddressFormatParams()
{
